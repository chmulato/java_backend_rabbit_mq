...
import com.mulato.axur.model.CrawlR        // Act & Assert
    ...
    private static ResultMatcher isApplicationJson() {
        return result -> {
            ...
            if (contentType == null || 
                ...
                throw new AssertionError("Expected Content-Type to be application/json or application/json;charset=UTF-8, but was: " + contentType);
            }
        };
    }
